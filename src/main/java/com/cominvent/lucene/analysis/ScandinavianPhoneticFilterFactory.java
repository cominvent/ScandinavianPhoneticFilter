 ...
 * 
 * Forked from com.findwise.extendedphonetics.ExtendedPhoneticFilterFactory
 * 
 ...
 *     &lt;filter class="com.cominvent.lucene.analysis.ScandinavianPhoneticFilterFactory" encoder="ScandinavianDoubleMetaphone" inject="true"/&gt;
 *   &lt;/analyzer&gt;
 * &lt;/fieldType&gt;</pre>
 * 
 * @see PhoneticFilter
 */
public class ScandinavianPhoneticFilterFactory extends TokenFilterFactory implements ResourceLoaderAware {
  ...
  static {
    registry.put("ExtendedDoubleMetaphone".toUpperCase(), ScandinavianDoubleMetaphone.class );
  ...
  public ScandinavianPhoneticFilterFactory(Map<String,String> args) {
    super(args);
